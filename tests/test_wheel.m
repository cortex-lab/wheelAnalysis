classdef test_wheel < matlab.unittest.TestCase
  ...
  methods(Test)
    function test_values(testCase)
      ...
      [mon, mof, s, vel, amp] = wheel.findWheelMoves3(data.wval, data.wt, 1000);
      ...
      testCase.verifyEqual(s, data.s, 'Unexpected displacements')
      testCase.verifyEqual(vel, data.vel, 'Unexpected peak velocity times')
      testCase.verifyEqual(amp, data.amp, 'Unexpected peak amplitudes')
    end
